...
const AdmissionsFilter :React.FC<AdmissionFiltersDialogProps> = ({ getAdmissions }) => {
  ...
  >
    {({ handleSubmit, resetForm }) => (
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4, lg: 4, xl: 4 }}>
          <CustomFields name="admissionNumber" label="Admission Number" placeholder="Enter Admission Number" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4, lg: 4, xl: 4 }}>
          <CustomSelect
            name="admissionType"
