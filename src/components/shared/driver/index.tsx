...
import { useDriverIds, useTruckDriverByAttributes } from 'src/api/hooks/useTruckDriverByAttributes';
...
const DriverSelector: React.FC<Props> = ({
    ...
    const [selected, setSelected] = useState<DriverType | DriverIdsType | null>(null);
    ...
    const handleSelection = (_event: any, newValue: DriverType | DriverIdsType | null) => {
